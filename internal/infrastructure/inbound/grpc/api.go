...
import (
	"context"
	inport "pinstack-relation-service/internal/domain/ports/input/service"
...
type FollowGRPCService struct {
	...
	relationService     inport.FollowService
	log                 ports.Logger
...
func NewFollowGRPCService(relationService inport.FollowService, log ports.Logger) *FollowGRPCService {
